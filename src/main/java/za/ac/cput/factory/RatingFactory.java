...
public class RatingFactory {
    ...
    public static Rating rateBuild(Long id, int overAllRating, int bookConditionRating, int sellerReliabilityRating, int valueRating, int deliveryRating, int accuracyOfRating){
